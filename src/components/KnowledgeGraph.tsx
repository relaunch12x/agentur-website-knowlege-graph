...
const nodes: GraphNode[] = [
  ...
  // Positionierung Cluster
  {
    ...
    details: ["USP: Wissenssystem statt Agentur", "3 Differenzierungsmerkmale", "Validiert durch Wissens-Audit"],
    validation: "Fakt",
    confidence: 0.91,
  },
  {
  ...
  // Zielgruppen Cluster
  {
    ...
    group: "zielgruppen",
    size: 26,
    description: "3 validierte Personas aus Wissens-Audit.",
  ...
  },
  {
    ...
    details: ["Tagline: From 1 to X", "Problem: Hoffnung ist keine Strategie", "Proof: Deine Daten rein. 1 Knowledge Graph raus."],
    validation: "Qualitative Daten",
    confidence: 0.84,
  },
